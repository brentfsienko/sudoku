...
export const CORE_BREEDS: DailyBreed[] = [
  ...
  },
  {
    ...
    name: "Beagle",
    origin: "England",
    height: "13 in & under, 13–15 in",
    weight: "under 20 lb (13 in & under), 20–30 lb (13–15 in)",
  ...
  },
  {
    ...
    weight: "24 lb (male), 22 lb (female)",
  ...
  },
  {
    ...
    weight: "65–80 lb (male), females are about 15 lb less than male",
  ...
  },
  {
    ...
    weight: "100–130 lb (male), 70–100 lb (female)",
  ...
  },
  {
    ...
    weight: "130–150 lb (male), 100–120 lb (female)",
