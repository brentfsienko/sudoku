...
export function AppFrame({ children, variant = "background" }: Props) {
  ...
  return (
    ...
    >
      <div
        className={`relative mx-auto flex min-h-0 w-full max-w-md flex-1 flex-col overflow-hidden md:h-[min(90dvh,880px)] md:max-h-[min(90dvh,880px)] md:flex-none md:rounded-lg md:shadow-[0_12px_48px_rgba(74,59,47,0.14)] md:ring-1 md:ring-black/[0.06] ${mobileBg}`}
